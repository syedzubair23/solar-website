...
function Stats() {
  return (
    <div className="bg-[url('/images/stats-bgimage.png')] bg-no-repeat bg-[top_right_-20rem] sm:bg-right-top lg:bg-center max-w-7xl mx-auto mb-16 md:mb-28 px-4 pt-16 pb-32 sm:px-6 lg:px-8">
      ...
      <div className="font-poppins space-y-20">
        <div className="space-y-10">
          ...
          <p className="text-base text-[#D9F4FD] text-center md:text-left mx-auto md:mx-0 max-w-prose">
        ...
        <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-14 justify-items-center px-8 py-16 bg-white/10 shadow-[0px_0px_40px_rgba(0,0,0,0.25)] rounded-3xl backdrop-blur-3xl">
